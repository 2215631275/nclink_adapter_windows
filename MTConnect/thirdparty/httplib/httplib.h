...
public:
  ...
  void set_address(const std::string& scheme_host_port);
  void set_address(const std::string& scheme_host_port,
      const std::string& client_cert_path,
      const std::string& client_key_path);
...
inline void Client::set_address(const std::string& scheme_host_port) {
    set_address(scheme_host_port, std::string(), std::string());
}
