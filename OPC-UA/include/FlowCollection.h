#ifndef FLOW_COLLECTION
#define FLOW_COLLECTION
#include <iostream>
...
{
public:
    FlowCollection(nlohmann::json sampleItem, std::string dev_uuid, std::int32_t sampleinterval, std::int32_t uploadinterval, mqtt::async_client& cli);
    ~FlowCollection();
