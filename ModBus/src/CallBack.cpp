...
/*RegisterSampleRequest registerSampleRequest;
UnregisterSampleRequest unregisterSampleRequest;*/
std::map<std::string, ProcessJsonData*> processJsonMap
{
	...
	//{"FlowCollection/", &flowCollection}
	//{"Register/Sample/Request/",&registerSampleRequest},
	//{"Unregister/Sample/Request/",&unregisterSampleRequest}
};
...
void CallBack::connected(const std::string& cause)
{
	...
	//versionData["privateInfo"] = NULL;
 	versionData["@id"] = config.config["dev_uuid"];
	versionData["cli_uuid"] = config.config["dev_uuid"];
	versionData["version"] = config.config["model_config"]["version"];
	versionData["privateInfo"] = NULL;
